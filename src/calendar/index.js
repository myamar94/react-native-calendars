...
class Calendar extends Component {
  ...
  constructor(props) {
    ...
    this.renderDayName = this.renderDayName.bind(this);
  ...
  render() {
    ...
    return (
      <View style={[this.style.container, this.props.style]}>
        {this.props.weekLabelPosition === "top" &&
          this.renderDayName(indicator)}
        <View style={this.style.monthView}>{weeks}</View>
        {this.props.weekLabelPosition === "bottom" &&
          this.renderDayName(indicator)}
      </View>
    );
  }
